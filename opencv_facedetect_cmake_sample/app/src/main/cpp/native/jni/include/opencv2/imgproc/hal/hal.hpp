...
//! @{
        ...
        struct CV_EXPORTS Filter2D {
            static Ptr<hal::Filter2D> create(uchar *kernel_data, size_t kernel_step,
                                             int kernel_type,
        ...
        struct CV_EXPORTS Morph {
            static Ptr<Morph> create(int op, int src_type, int dst_type, int max_width,
                                     int max_height,
            ...
            virtual void apply(uchar *src_data, size_t src_step, uchar *dst_data, size_t dst_step,
                               int width, int height,
