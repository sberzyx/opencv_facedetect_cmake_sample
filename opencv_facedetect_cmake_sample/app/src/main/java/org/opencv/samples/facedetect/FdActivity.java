...
import com.example.shinelon.opencvcmaketest.R;
...
public class FdActivity extends Activity implements CvCameraViewListener2 {
    ...
    private int mCameraId = JavaCameraView.CAMERA_ID_FRONT;
        ...
        btnSwitchCamera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCameraId == JavaCameraView.CAMERA_ID_FRONT) {
                    mCameraId = JavaCameraView.CAMERA_ID_BACK;
                } else {
                    mCameraId = JavaCameraView.CAMERA_ID_FRONT;
                }
                mOpenCvCameraView.setCameraIndex(mCameraId);
...
//                System.loadLibrary("opencv_java3.so");
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
